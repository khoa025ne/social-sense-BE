          ...
          return (
            <motion.button
              ...
              className={cn(
                ...
                isSelected
                  ? "bg-gradient-to-r from-blue-500 to-violet-500 text-white shadow-md font-bold"
          ...
          <motion.button
            ...
            className={cn(
              ...
              !isSelected &&
                ...
                !inRange &&
                "text-foreground hover:bg-accent",
              isSelected && "bg-gradient-to-r from-blue-500 to-violet-500 text-white shadow-md font-bold",
              isTodayDate &&
                !isSelected &&
