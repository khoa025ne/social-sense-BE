...
#r "nuget: DocumentFormat.OpenXml, 3.5.1"
    ...
    string labelB, (string key, string val)[] dataB)
{
    ...
    Console.WriteLine($"Created: {path} ({new FileInfo(path).Length} bytes)");
}

// ── File 1: TikTok ────────────────────────────────────────────────────────────
var tikA = new (string, string)[]
{
    ("Tổng tiếp cận",           "482300"),
    ("Lượt hiển thị",           "610000"),
...
var tikB = new (string, string)[]
{
    ("Tổng tiếp cận",           "419000"),
    ("Lượt hiển thị",           "530000"),
    ("Tổng tương tác",          "82500"),
    ("Lượt thích",              "66000"),
    ("Bình luận",               "8250"),
    ("Lượt chia sẻ",            "4125"),
    ("Lượt click",              "12570"),
    ("Người theo dõi mới",      "1910"),
    ("Lượt xem trang cá nhân",  "8200"),
    ("Tỉ lệ tương tác (%)",     "18.9"),
    ("Tỷ lệ hoàn thành (%)",    "69.4"),
    ("Thời gian xem TB (giây)", "96"),
    ("Tỷ lệ chuyển đổi (%)",    "3.5"),
    ("CTR (%)",                 "2.6"),
    ("Số bài đăng",             "25"),
};

CreateFile(@"C:\Temp\analytics_tiktok_test.xlsx",
    "TikTok", "Thang6_2026", tikA, "Thang5_2026", tikB);

// ── File 2: Facebook ──────────────────────────────────────────────────────────
var fbA = new (string, string)[]
{
    ("Tổng tiếp cận",         "95400"),
    ("Lượt hiển thị",         "142000"),
    ("Tổng tương tác",        "2862"),
    ("Lượt thích",            "2100"),
    ("Bình luận",             "480"),
    ("Lượt chia sẻ",          "282"),
    ("Lượt click",            "1430"),
    ("Người theo dõi mới",    "320"),
    ("Tỉ lệ tương tác (%)",   "3.0"),
...
var fbB = new (string, string)[]
{
    ("Tổng tiếp cận",         "78200"),
    ("Lượt hiển thị",         "115000"),
    ("Tổng tương tác",        "2190"),
    ("Lượt thích",            "1650"),
    ("Bình luận",             "380"),
    ("Lượt chia sẻ",          "160"),
    ("Lượt click",            "1100"),
    ("Người theo dõi mới",    "245"),
    ("Tỉ lệ tương tác (%)",   "2.8"),
...
CreateFile(@"C:\Temp\analytics_facebook_test.xlsx",
    "Facebook", "Thang6_2026", fbA, "Thang5_2026", fbB);

Console.WriteLine("Done! Files ready at C:\\Temp\\");
